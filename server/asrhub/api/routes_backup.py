...
def _разнести(state: Any) -> None:
    ...
    try:
        ...
        pass
    # Приёмники метрик и правила тревог из копии — тоже сразу: мониторинг
    # читает свои настройки сам, и без этого восстановленные приёмники
    # начинали работать только после перезапуска.
    from .routes_system import _применить_мониторинг  # noqa: PLC0415
