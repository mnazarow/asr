...
_m(MetricSpec(
    ...
    description=(
        "Сумма пауз от трёх секунд на запись, в среднем за сутки. Порог "
        "три секунды — тот же, что у NICE («заметная тишина») и Amazon "
        "Contact Lens; Genesys берёт две, Google — пять."
    ),
    recommendation=(
