...
Запустится мастер: определит железо и задаст шесть вопросов, у каждого — готовый ответ по умолчанию. Enter шесть раз даёт рабочую установку. Чтобы обойтись без вопросов, добавьте `--profile standard --yes`.
