...
| `GET` | `/api/content` | Полный отчёт по содержанию записей | любой действующий ключ |
...
| `POST` | `/api/content/recompute` | Пересчитать разбор архива | ключ с правом записи (**admin** или **user**) |
