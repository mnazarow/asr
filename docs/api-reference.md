...
Всего маршрутов: **176**, операций: **194**. Справочник собран из схемы OpenAPI работающего сервера, а примеры ответов сняты с него же, поэтому расходиться с действительностью им негде.
...
```json
{
  "overview": {
    "period": "week",
    "generated_at": 1789564489.7531672,
    "jobs": {
      "total": 0,
      "completed": 0,
      "failed": 0,
