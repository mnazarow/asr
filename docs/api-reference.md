...
Всего маршрутов: **75**, операций: **85**. Справочник собран из схемы OpenAPI работающего сервера, а примеры ответов сняты с него же, поэтому расходиться с действительностью им негде.
...
```json
{
  "overview": {
    "period": "week",
    "generated_at": 1788448976.3693583,
    "jobs": {
      "total": 260,
      "completed": 243,
      "failed": 9,
