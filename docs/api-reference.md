...
```json
{
  "overview": {
    "period": "week",
    "generated_at": 1789138050.5106392,
    "jobs": {
      "total": 267,
      "completed": 254,
      "failed": 9,
    ...
    "volume": {
      "audio_seconds": 250692.8,
      "audio_hours": 69.64,
      "processing_seconds": 39205.7,
      "words": 575977,
      "characters": 3394332,
      "segments": 26106,
      "files_per_hour": 1.51,
      "audio_hours_per_hour": 0.41
    },
    "performance": {
      "rtf": {
        "count": 254,
...
```json
{
  ...
  "overall": {
    "jobs": 254,
    "audio_hours": 69.637,
    "processing_p50": 45.33,
    "processing_p95": 659.73,
    "processing_p99": 1935.38,
    "rtf_p50": 0.1106,
    "rtf_p95": 0.42,
    "rtf_p99": 0.5201,
    "queue_p50": 13.7,
  ...
  "by_model": [
    {
      ...
      "audio_hours": 8.932,
      "processing_p50": 47.5,
      "processing_p95": 405.94,
      "processing_p99": 725.48,
      "rtf_p50": 0.1407,
      "rtf_p95": 0.1621,
      "rtf_p99": 0.1854,
      "queue_p50": 10.98,
    ...
    },
    {
      ...
      "jobs": 39,
      "audio_hours": 12.578,
      "processing_p50": 28.15,
      "processing_p95": 547.38,
      "processing_p99": 644.45,
      "rtf_p50": 0.1165,
      "rtf_p95": 0.1647,
      "rtf_p99": 0.1881,
      "queue_p50": 13.35,
    ...
    },
    {
      ...
      "audio_hours": 11.917,
      "processing_p50": 31.4,
      "processing_p95": 224.91,
      "processing_p99": 300.95,
      "rtf_p50": 0.0557,
      "rtf_p95": 0.0814,
      "rtf_p99": 0.0946,
      "queue_p50": 18.79,
...
```json
{
  ...
  "hardware": {
    ...
    "warnings": [
      ...
      "На диске свободно 19.6 ГБ. Полный набор моделей занимает свыше 100 ГБ."
    ]
  },
  "recommended": {
    "device": "cpu",
