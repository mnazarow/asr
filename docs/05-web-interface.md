...
Записи разговоров приезжают с Asterisk сами — журналом CDR, событиями AMI или обходом каталога записей. Сверху состояние забора: включён ли, какой источник, сколько звонков ввезено и по каким причинам пропущены остальные; кнопки «Проверить связь» и «Забрать сейчас» доступны администратору.

Ниже журнал звонков с отбором по периоду, направлению, очереди, оператору и номеру: кто кому звонил, через какую очередь, сколько длился разговор, чем кончился и что стало с распознаванием. Строка ведёт в карточку задания, где поля звонка стоят над расшифровкой.
