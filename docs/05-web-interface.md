...
Отдельно — отборы по здоровью распознавания, они работают и без разбора содержания: «подозрительная расшифровка», «похоже на галлюцинацию», «говорящих не столько, сколько ожидалось». Такая запись в карточке начинается с предупреждения и примеров подозрительных сегментов — щелчок по примеру ведёт к этому месту записи.
