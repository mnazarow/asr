...
Пять вкладок: **свод** с готовыми выводами, **разрезы** по владельцу, оператору, метке, часу и дню недели, **темы** с тем, что стало звучать чаще или реже, **связи** между признаками и **что послушать** — двенадцать готовых отборов записей.
