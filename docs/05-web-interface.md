...
В карточке: текст с таймкодами и говорящими, посегментная разбивка с уверенностью модели, все параметры, с которыми задание выполнялось, разбивка времени по стадиям, лента событий. Сегменты с низкой уверенностью подсвечиваются — по ним удобно вычитывать.
