...
В карточке задания появилась вкладка «Разбор»: ход тональности по разговору, оценка каждого говорящего отдельно, ключевые слова, категории обращения с примерами реплик, прозвучавшие суммы и сроки, обещания, тревожные упоминания и проверка по скрипту. Всё кликабельно по времени — щелчок переводит проигрыватель на нужную секунду.
