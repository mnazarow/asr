...
Те же отборы есть на вкладке «Что послушать» раздела «Аналитика записей» — там верхние пятьдесят, здесь весь список с листалкой и массовыми действиями. Кнопка «Все такие записи» переводит отсюда туда, сохраняя выбор.
...
Шесть вкладок: **свод** с готовыми выводами, **разрезы** по владельцу, оператору, метке, часу и дню недели, **темы** с тем, что стало звучать чаще или реже, **связи** между признаками, **что послушать** — двенадцать готовых отборов записей — и **скрипт разговора**, где обязательные пункты правятся строками и тут же проверяются на настоящей записи.

В карточке задания появилась вкладка «Разбор»: ход тональности по разговору, оценка каждого говорящего отдельно, ключевые слова, прозвучавшие суммы и сроки, обещания, тревожные упоминания и проверка по скрипту. Всё кликабельно по времени — щелчок переводит проигрыватель на нужную секунду.
