...
Сервис отдаёт наружу **72 метрики** в 11 группах: 54 мгновенных значения, 13 счётчиков и 3 гистограммы. У 27 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
