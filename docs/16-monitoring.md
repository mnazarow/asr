...
Сервис отдаёт наружу **93 метрики** в 12 группах: 75 мгновенных значений, 13 счётчиков и 3 гистограммы. У 35 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Содержание записей** | 19 | 7 | О чём и как шли разговоры: тональность, тревожные упоминания, обещания, скрипт, состояние разбора. |
