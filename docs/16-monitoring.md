...
Сервис отдаёт наружу **84 метрики** в 12 группах: 66 мгновенных значений, 13 счётчиков и 3 гистограммы. У 32 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Содержание записей** | 12 | 5 | О чём и как шли разговоры: тональность, тревожные упоминания, обещания, скрипт, состояние разбора. |
