...
Сервис отдаёт наружу **96 метрик** в 12 группах: 78 мгновенных значений, 13 счётчиков и 3 гистограммы. У 37 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Качество** | 6 | 5 | Уверенность модели, WER и CER, доля записей без речи. |
