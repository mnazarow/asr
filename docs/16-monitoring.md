...
Сервис отдаёт наружу **112 метрик** в 12 группах: 93 мгновенных значения, 14 счётчиков и 3 гистограммы. У 44 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
**Порог:** предупреждение — ниже 1.0; критично — ниже 0.5; выдержка 1800 с.
...
**Порог:** предупреждение — выше 1.0; критично — выше 2.0; выдержка 3600 с.
...
**Порог:** предупреждение — ниже 21474836480; критично — ниже 5368709120; выдержка 300 с.
...
**Порог:** предупреждение — выше 1; критично — выше 5; выдержка 600 с.
...
Средняя доля выполненных пунктов скрипта, от 0 до 1. Считается по репликам того, кто заговорил первым.
...
Балл 0–100 по записям за сутки: сумма весов выполненных пунктов скрипта к сумме всех, минус штрафы сработавших категорий (стоп-слова). Считается, как у Verint Quality Bots и Google Quality AI; без пунктов скрипта балла нет.
