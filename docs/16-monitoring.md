...
Сервис отдаёт наружу **104 метрики** в 12 группах: 86 мгновенных значений, 13 счётчиков и 3 гистограммы. У 41 метрики заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Качество** | 11 | 7 | Уверенность модели, WER и CER, доля записей без речи. |
