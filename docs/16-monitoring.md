...
Сервис отдаёт наружу **106 метрик** в 12 группах: 88 мгновенных значений, 13 счётчиков и 3 гистограммы. У 42 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Качество** | 13 | 8 | Уверенность модели, WER и CER, доля записей без речи. |
