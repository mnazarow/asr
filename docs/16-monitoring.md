...
Сервис отдаёт наружу **90 метрик** в 12 группах: 72 мгновенных значения, 13 счётчиков и 3 гистограммы. У 35 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Содержание записей** | 16 | 7 | О чём и как шли разговоры: тональность, тревожные упоминания, обещания, скрипт, состояние разбора. |
