...
Сервис отдаёт наружу **71 метрику** в 11 группах: 53 мгновенных значения, 13 счётчиков и 3 гистограммы. У 27 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Оборудование** | 15 | 4 | Процессор, память, видеокарта, диск. |
