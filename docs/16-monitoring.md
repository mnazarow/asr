...
**Метрика:** `asrhub_model_disagreement` · **Тип:** мгновенное значение · **Метки:** `model`

Среднее расхождение (WER одной расшифровки относительно другой) между основной моделью и контрольной по прогонам за неделю; метка model — основная модель. Точность без эталона это не меряет: меряет согласие двух независимых распознавателей, и важен его ход.
