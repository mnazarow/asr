...
Сервис отдаёт наружу **99 метрик** в 12 группах: 81 мгновенное значение, 13 счётчиков и 3 гистограммы. У 38 метрик заданы пороги тревоги, у каждой есть описание и рекомендация.
...
| **Качество** | 9 | 6 | Уверенность модели, WER и CER, доля записей без речи. |
