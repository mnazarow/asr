...
| Узнать, о чём и как говорили в записях | [19. Аналитика записей](19-content-analytics.md) |
| Понять, куда всё это идёт со временем | [20. Тренды](20-trends.md) |
| Подключить АТС и разбирать разговоры с неё | [21. Телефония](21-telephony.md) |
| Посмотреть показатели по каждому сотруднику | [22. Аналитика по сотрудникам](22-employees.md) |
| Снимать копии и восстанавливаться из них | [23. Резервные копии](23-backup.md) |
| Забирать звонки со станции, до которой не дотянуться | [24. Агент на станции Asterisk](24-agent.md) |
| Увидеть всю систему разом и найти, что сломалось | [25. Дашборд и автодиагностика](25-dashboard.md) |
| Понять, что модель поняла из разговоров | [26. Голосовая аналитика и очередь к модели](26-voice-analytics.md) |
| Связать звонки с людьми и отделами | [27. Справочник сотрудников](27-employees-directory.md) |
| Узнать, что ещё стоит доделать | [18. Ревизия кода](18-review.md) |
| Понять, куда развивать аналитику дальше | [Предложения 2026](proposal-2026.md) |
...
│   ├── content/          разбор содержания записей: правила, словари, категории
│   ├── llm/              смысловой слой: локальная языковая модель и её обвязка
...
└── tests/                873 проверки, включая двадцать три в настоящем браузере
```
