...
- **Главное** — записи, звонки, наговоренное время, балл, настроение клиента, напряжение, понятность, индекс NPS (предсказанный);
- **Речь** — понятность, точность, ритмичность, слова-паразиты, уменьшительно-ласкательные, усталость;
- **Клиенты** — тональность, настроение, напряжение, усилие клиента, индекс NPS (предсказанный) и отдельно — индекс по баллам, которые клиенты назвали вслух;
