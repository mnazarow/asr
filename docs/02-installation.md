...
Мастер спрашивает: что установить, куда, на каком порту, кто сможет подключаться, нужен ли автозапуск, выравнивание и отправка метрик. Перед началом работы он показывает сводку и просит подтверждения — до этого момента на диске ничего не меняется.
